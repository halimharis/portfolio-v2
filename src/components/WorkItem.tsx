...
function WorkItem({ project, field, year }: IWorkItem) {
  return (
    <div className="grid grid-cols-12 w-full font-onest py-8 border-b group border-black text-xl lg:bg-leftToRight-black transition-all duration-300 ease-out hover:text-white max-md:text-base">
